...
import me.wilsonhu.csce247.finalproject.objects.Event;
import me.wilsonhu.csce247.finalproject.objects.EventReview;
import me.wilsonhu.csce247.finalproject.objects.Review;
...
public class ReviewDatabase extends SavableDatabase{
    ...
    public void loadReviews() {
        ...
        setEventReviews(read(REVIEW_FILE_NAME, new TypeToken<HashSet<EventReview>>(){}.getType()));
    }
